...
$query=mysqli_query($conn,"SELECT * FROM users WHERE email='$email' and number='$number'");
$num=mysqli_fetch_array($query);
if($num>0)
{
$extra="index.php";
mysqli_query($conn,"update users set password='$password' WHERE email='$email' and number='$number' ");
