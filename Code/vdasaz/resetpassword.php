...
$query=mysqli_query($link,"SELECT * FROM users WHERE email='$email' and number='$number'");
...
{
$extra="index.php";
mysqli_query($link,"update users set password='$password' WHERE email='$email' and number='$number' ");
