...
<div class="form-container">
   ...
   <form action="" method="post">
	  ...
	  <div class="form-row">
	  <br>
      <input type="text" name="name" placeholder="enter your name" id = "nme" required class="box" required maxlength="7" onchange="Validate();">
	  </div>
...
document.getElementById('msg15').innerHTML=" ";
    return true;
	  ...
	  <div class="form-row">
      <input type="password" name="password" placeholder="enter your password" id="pwd" required class="box" required onchange="return Validp();">
	  </div>
